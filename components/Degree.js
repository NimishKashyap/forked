...
function Degree(){
    return(
        <div className="mx-4 sm:mx-12 my-10">
            ...
            <div className="sm:grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-2 flex overflow-x-scroll scrollbar-hide items-center justify-left gap-4 sm:gap-6">
                <div className="shadow-md w-full flex justify-center items-left flex-col">
