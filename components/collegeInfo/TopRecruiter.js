...
<div className="mt-2">
      <div className="flex border-b-2 rounded-sm border-borderColor-500 gap-5 my-4 w-fit -mb-0">
...
<div className="flex gap-6 justify-start">
      ...
      <p className="text-dark-700 text-sm w-5/6"> • ₹ 55.88 LPA marks the highest domestic salary making.
      <br></br>
