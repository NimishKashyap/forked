...
function Banner() {
  return (
    ...
    <div className="w-100 h-237 rounded bg-no-repeat bg-cover flex items-left justify-center flex-col pl-6 sm:pl-12" style={{backgroundImage:`url('/collegeInfo/bannerCollege.png')`}}>
      <div className="flex mr-4 sm:mr-8 mt-10">
          <div className="mt-2">
          <Image src="/collegeInfo/collegeLogo.svg" alt="college-logo" width="92px" height="92px" />
          </div>
          <div className="w-full ml-2 sm:ml-6 flex flex-col gap-5">
          <div>
              <h1 className="text-fadeWhite-400 font-bold text-2xl lg:text-4xl w-full md:w-9/12 lg:w-1/2 leading-0 sm:leading-10">Indian Institutes of Management Ahmedabad</h1>
          </div>
          <div className="flex lg:flex-row flex-col gap-4 justify-between w-full">
              <div className="flex gap-6 text-2xl text-fadeWhite-400 items-center justify-left -mt-4">
                  <p className="text-xs sm:text-lg lg:text-2xl text-fadeWhite-400 w-fit">Estd. in 1947</p>
                  <div className="flex items-center">
                  <Image src="/collegeInfo/locate-white.png" alt="locate" width="13px" height="20px" />
                  <p className="text-xs sm:text-lg lg:text-2xl text-fadeWhite-400 ml-2 w-fit">
                  Ahmedabad, Gujarat</p>
                  </div>
              </div>
              <div className="flex gap-4 sm:mb-0 mb-6">
