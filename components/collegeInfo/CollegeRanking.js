...
function CollegeRanking() {
  return <div className="mx-4 sm:mx-12 my-10">
      ...
      <div className="hidden md:flex border-b-2 rounded-sm border-borderColor-500 gap-3 my-4 w-fit overflow-x-scroll scrollbar-hide">
            <p className="font-normal text-base text-dark-200 w-3/12">Overall National</p>
            <p className="font-normal text-base text-dark-200 w-3/12">Overall National</p>
            <p className="font-normal text-base text-dark-200 w-3/12">Overall National</p>
            <p className="font-normal text-base text-dark-200 w-3/12">Overall National</p>
            <p className="font-normal text-base text-dark-200 w-3/12">Overall National</p>
