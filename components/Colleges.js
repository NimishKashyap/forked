...
function Colleges(){
    return(
        <div className="mx-4 sm:mx-12 my-12">
            ...
            <div className="flex gap-6 overflow-x-scroll scrollbar-hide justify-between pb-10">
                <div className="shadow-xl rounded-md">
                    ...
                    <div className="flex my-2 ml-3">
                        <Image src="/colleges/location-color.png" alt="" width="17px" height="12px" />
                        <p className="ml-2">
                        Kashipur
                        </p>
                    </div>
                ...
                <div className="shadow-xl rounded-md">
                    ...
                    <div className="flex my-2 ml-3">
                        <Image src="/colleges/location-color.png" alt="" width="17px" height="10px" />
                        <p className="ml-2">
                        Kashipur
                        </p>
                    </div>
                ...
                </div><div className="shadow-xl rounded-md">
                    <Image src="/colleges/2.png" alt="college" width="200px" height="234px" />
                    <h1 className="w-48 ml-3 font-bold text-dark-500 text-base">
                    Indian Institute of Management (IIM) 
                    </h1>
